...
$query = "SELECT COALESCE(sum(duration)/3600,0) as \"duracion\",courses100.name FROM courses100 LEFT JOIN studydata100 ON (courses100.courseID = studydata100.courseID) AND studydata100.initialTime>(UNIX_TIMESTAMP()-60*60*24*7*2) WHERE courses100.user=" . $id . " GROUP BY courses100.courseID";
