...
<a class="navbar-brand" href="">Academic dashboard</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="/myownlifedashboard/academic/mainPage/index.php" id="mainpage">Main page</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/myownlifedashboard/academic/unplannedActivity" id="unplannedActivityNavbar">Unplanned Activity</a>
      </li>
      <li class="nav-item">
