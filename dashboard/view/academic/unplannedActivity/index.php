            ...
            <div class="col-sm-6 mt-1">
                <div class="d-flex justify-content-center justify-content-sm-start sm-6">
                    ...
                    <ul class="dropdown-menu" id="selectCourse">
                        <li><a class="dropdown-item" onclick=" courseClicked({courseID:-1,courseName:'Undefined'}) ">Undefined</a></li>
                ...
                <div class="d-flex justify-content-center justify-content-sm-start sm-6 mt-1">
                    ...
                    <ul class="dropdown-menu" id="selectProject">
                        <li><a class='dropdown-item' onclick="projectClicked({ projectID: -1, projectName: 'Undefined' })">Undefined</a></li>
                    </ul>
                </div>
                ...
                <div class="d-flex justify-content-center justify-content-sm-start sm-6 mt-1">
                    ...
                    <ul class="dropdown-menu" id="selectTypeOfStudy">
                        <li><a class='dropdown-item' onclick="typeOfStudyClicked({ typeOfStudyID: -1, typeOfStudyName: 'Undefined' })">Undefined</a></li>
